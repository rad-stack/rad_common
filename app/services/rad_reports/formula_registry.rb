module RadReports
  class FormulaRegistry
    # Define all formulas with their complete lifecycle: metadata, param extraction, and execution
    FORMULAS = {
    ...
    class << self
      ...
      # Execute a single formula transformation
      ...
      # Returns formula registry as JSON for JavaScript (excludes Ruby lambdas)
      def to_json_config
      ...
      # Returns grouped formulas for select dropdown
      def grouped_options
