...
RSpec.describe 'NotificationSettings', type: :system do
  ...
  describe 'index' do
    context 'when admin' do
      ...
      it 'updates the settings successfully without save button', :gha_specs_only, :js do
        visit '/rad_common/notification_settings'
      ...
      it 'displays error message when updating without button', :gha_specs_only, :js do
        visit '/rad_common/notification_settings'
