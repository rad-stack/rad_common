...
RSpec.describe 'NotificationSettings', type: :system do
  ...
  describe 'index' do
    context 'when admin' do
      ...
      xit 'updates the settings successfully without save button', :js, :legacy_asset_specs do
        visit '/notification_settings'
      ...
      xit 'displays error message when updating without button', :js, :legacy_asset_specs do
        visit '/notification_settings'
