module DivisionsHelper
  def division_show_data(division)
    [:name, :code, :notify, :timezone, :hourly_rate, :additional_info,
     ...
     { label: 'Avatar',
       value: render('layouts/attachment', record: division, attachment_name: 'avatar', new_tab: true) },
     { label: 'Attachment',
       value: render('layouts/attachment', record: division, attachment_name: 'attachment', new_tab: true) },
