...
ActiveRecord::Schema[7.2].define(version: 20_251_027_181_305) do
  ...
  create_table 'assistant_sessions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[chat_scope_type chat_scope_id], name: 'index_assistant_sessions_on_chat_scope'
    t.index %w[contextable_type contextable_id], name: 'index_assistant_sessions_on_contextable'
  ...
  create_table 'attorneys', force: :cascade do |t|
    ...
    t.index %w[first_name last_name mobile_phone],
            name: 'index_attorneys_on_first_name_and_last_name_and_mobile_phone', unique: true
  end
  ...
  create_table 'audits', force: :cascade do |t|
    ...
    t.index %w[auditable_id auditable_type version], name: 'auditable_index'
  ...
  create_table 'clients', force: :cascade do |t|
    ...
    t.index %w[name business_type], name: 'index_clients_on_name_and_business_type', unique: true,
  ...
  create_table 'contact_logs', force: :cascade do |t|
    ...
    t.index %w[record_type record_id], name: 'index_contact_logs_on_record'
  ...
  create_table 'duplicates', force: :cascade do |t|
    ...
    t.index %w[duplicatable_type duplicatable_id],
            name: 'index_duplicates_on_duplicatable_type_and_duplicatable_id', unique: true
  end
  ...
  create_table 'embeddings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[embeddable_type embeddable_id], name: 'index_embeddings_on_embeddable_type_and_embeddable_id',
                                               unique: true
  ...
  create_table 'notification_security_roles', force: :cascade do |t|
    ...
    t.index %w[notification_type_id security_role_id], name: 'unique_notification_roles', unique: true
  ...
  create_table 'notification_settings', force: :cascade do |t|
    ...
    t.index %w[notification_type_id user_id],
            name: 'index_notification_settings_on_notification_type_id_and_user_id', unique: true
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.index %w[record_type record_id], name: 'index_notifications_on_record_type_and_record_id'
  ...
  create_table 'saved_search_filters', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id name search_class], name: 'unique_saved_search_filters', unique: true
  ...
  create_table 'user_clients', force: :cascade do |t|
    ...
    t.index %w[user_id client_id], name: 'index_user_clients_on_user_id_and_client_id', unique: true
  ...
  create_table 'user_security_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[security_role_id user_id], name: 'index_user_security_roles_on_security_role_id_and_user_id',
                                          unique: true
