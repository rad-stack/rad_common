...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'mb-3' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, class: 'form-check me-3' do |bb|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check me-3', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-3' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_select, class: 'mb-3' do |b|
    ...
    b.use :label, class: 'form-label'
    b.use :icon
    b.use :input, class: 'form-select form-control', error_class: 'is-invalid', valid_class: ''
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :horizontal_boolean, class: 'row mb-3' do |b|
    ...
    b.wrapper :grid_wrapper, class: 'col-sm-9 offset-sm-3' do |wr|
      wr.wrapper :form_check_wrapper, class: 'form-check me-3' do |bb|
        bb.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: ''
        bb.use :label, class: 'form-check-label'
        bb.use :icon
        bb.use :full_error, wrap_with: { class: 'invalid-feedback' }
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check me-3', item_label_class: 'form-check-label', class: 'row mb-3' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_select, class: 'row mb-3' do |b|
    ...
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-select form-control', error_class: 'is-invalid', valid_class: ''
      ba.use :full_error, wrap_with: { class: 'invalid-feedback' }
      ba.use :hint, wrap_with: { class: 'form-text' }
    end
  end
  ...
  config.wrappers :horizontal_multi_select, class: 'row mb-3' do |b|
    ...
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.wrapper class: 'd-flex flex-row justify-content-between align-items-center' do |bb|
        bb.use :input, class: 'form-select form-control mx-1', error_class: 'is-invalid', valid_class: ''
      end
      ba.use :full_error, wrap_with: { class: 'invalid-feedback d-block' }
      ba.use :hint, wrap_with: { class: 'form-text' }
    end
