...
RSpec.describe RadCommon::TwilioErrorThresholdChecker, type: :service do
  describe 'check_threshold' do
    ...
    context 'when threshold is exceeded' do
      before do
        create_list :contact_log, 23, service_status: :delivered
        create_list :contact_log, 10, service_status: :undelivered
    ...
    context 'when threshold is not exceeded' do
      before do
        create_list :contact_log, 24, service_status: :delivered
        create_list :contact_log, 1, service_status: :undelivered
        described_class.new.check_threshold
      end
    ...
    context 'when min failures is not exceeded' do
      before do
        create_list :contact_log, 2, service_status: :delivered
        create_list :contact_log, 8, service_status: :undelivered
        described_class.new.check_threshold
      end
