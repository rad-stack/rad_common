...
RSpec.describe RadCommon::AppInfo, type: :service do
  ...
  describe 'application_tables' do
    ...
    let(:result) do
      %w[attorneys categories clients companies contact_logs divisions duplicates notification_security_roles
         notification_settings notification_types notifications saved_search_filters security_roles statuses
