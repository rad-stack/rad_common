...
RSpec.describe RadCommon::AppInfo, type: :service do
  ...
  describe 'application_tables' do
    ...
    let(:result) do
      %w[attorneys categories clients companies contact_log_attachments contact_logs divisions duplicates
         notification_security_roles notification_settings notification_types notifications saved_search_filters
         security_roles statuses system_messages user_clients user_security_roles user_statuses users]
    end
  ...
  describe 'application_models' do
    ...
    let(:result) do
      %w[Attorney Category Client Company ContactLog ContactLogAttachment Division Duplicate Notification
