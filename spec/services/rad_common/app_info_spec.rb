  ...
  describe 'application_tables' do
    ...
    let(:result) do
      %w[attorneys categories clients companies contact_log_recipients contact_logs
         divisions duplicates notification_security_roles notification_settings
         notification_types notifications security_roles statuses system_messages
  ...
  describe 'application_models' do
    ...
    let(:result) do
      %w[Attorney Category Client Company ContactLog ContactLogRecipient
         ...
         NotificationType SecurityRole Status SystemMessage
  ...
  describe 'audited_models' do
    ...
    let(:result) do
      %w[Attorney Category Client Company ContactLog ContactLogRecipient Division NotificationSecurityRole
         NotificationSetting SecurityRole Status User UserClient UserSecurityRole]
    end
